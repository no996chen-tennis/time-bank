...
> 本文件是 Claude Code Project 会自动加载的项目索引。当前 PRD 版本：**V1.3.1**（2026-04-22 晚）
...
### 顶部「时间余额」维度（V1.3.1 新增）

主页顶部还有一个特殊的**系统维度 `lifespan`**，作为"人生总倒计时"的哲学 anchor：
...
- `Use-Cases-详尽交互.md` — **V1.2** 所有模块 CRUD 逐步交互（工程交付真相源）
