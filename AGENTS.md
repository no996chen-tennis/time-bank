...
> 本文件是 Codex Project 会自动加载的项目索引。当前 PRD 版本：**V1.3.2**（2026-04-22 晚晚 · UI 定稿）
...
- `M1-ChatGPT-启动prompt.md` — **给 ChatGPT 的 M1 数据层任务启动 prompt**（Adam 直接复制发出）
- `designs/DesignTokens.swift` — 从 Codex Design 提取的 Swift 常量（ChatGPT 写 SwiftUI 的色/字/间距源）
- `designs/v1-ui-final.html` — Codex Design UI 定稿 bundle（双击本地打开查看）
