...
> - 账户 Tab 升 P0；"今日此刻"、自定义时间账户 CRUD、分享卡、视频拍摄、保存到相册、桌面 Widget、StandBy、**Dark Mode**、多格式导出、从 ZIP 恢复——全部推迟到 V1.1+
...
| `occurrenceCount(n, noun)` | 次数（消耗层用）| `约 92 次见面`、`约 40 年`、`每周约 5h` | 时间账户卡副文案 |
